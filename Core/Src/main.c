...
static uint32_t adcBuffer[NB_ADC1_PINS + NB_ADC3_PINS]; // Tampon pour stocker les valeurs des ADC
uint32_t *adc1_buffer = &adcBuffer[0];
uint32_t *adc3_buffer = &adcBuffer[NB_ADC1_PINS];
